/**
 * Versão que já tem uma versão funcional de cálculo do dia da semana de uma data, 
 * mas apenas se o dia da semana a calcular corresponder a uma data igual ou superior 
 * à data de referência (1 de janeiro de 1900)
 * 
 * Far-se-á na próxima aula uma versão que funciona para qualquer data igual ou superior a 1 de janeiro de 1600
 * (ano inicial do intervalo de anos considerado válido)
 */
